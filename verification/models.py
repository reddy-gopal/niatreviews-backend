...
Senior verification: SeniorProfile, SeniorRegistration, MagicLoginToken, SeniorFollow.
Phone OTP: handled by MSG91 via verification/otp_views and msg91_client (no model).
"""
import uuid
